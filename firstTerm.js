...
request.onerror = () =>{
    console.log('Error opening firstTerm database')
}
...
function displayTable(){
    ...
    let studentFirstTerm = document.querySelector('#student-firstTerm tbody');
    studentFirstTerm.innerHTML = '';
    ...
    firstTermStore.openCursor().onsuccess = (event)=>{
        ...
        subjectRequest.onsuccess = () =>{
            ...
            editBtn.onclick = function(){
                ...
                const firstTerm = transaction.objectStore('firstTerm');
                const updateRequest = firstTerm.put(updateFirstTerm);
            ...
            cellDelete.onclick = function(){
                const deleteTerm = db.transaction('firstTerm', 'readwrite');
                const store = deleteTerm.objectStore('firstTerm');
            ...
            studentFirstTerm.appendChild(row);
            }
        }
        cursor.continue();
        }
