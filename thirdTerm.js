...
request.onerror = () =>{
    console.log('Error opening thirdTerm database')
}
...
function displayTable(){
    ...
    let studentthirdTerm = document.querySelector('#student-thirdTerm tbody');
    studentthirdTerm.innerHTML = '';
    ...
    thirdTermStore.openCursor().onsuccess = (event)=>{
        ...
        subjectRequest.onsuccess = () =>{
            ...
            editBtn.onclick = function(){
                ...
                const thirdTerm = transaction.objectStore('thirdTerm');
                const updateRequest = thirdTerm.put(updatethirdTerm);

                updateRequest.onsuccess = () =>{
                    console.log('Update made on thirdTerm Result')
            ...
            cellDelete.onclick = function(){
                const deleteTerm = db.transaction('thirdTerm', 'readwrite');
                const store = deleteTerm.objectStore('thirdTerm');
            ...
            studentthirdTerm.appendChild(row);
            }
        }
        cursor.continue();
        }
