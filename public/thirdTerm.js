...
async function attInfo() {
  ...
  const transaction = db.transaction("attendance3", "readonly");
  const store = transaction.objectStore("attendance3");

  const attendance3Info = document.getElementById("attendance3-info");
  let count = 0;
